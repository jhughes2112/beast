...
// Discards everything sent to it. Used for the throwaway sub-sessions behind a tool — the media
// inspection stage session in particular — whose work belongs in the tool's result block, not

...
public static class ReasoningEffort
{
    ...
    public static string DisplayWord(string? word)
    {
        ...
        switch (level)
        {
            case ReasoningLevel.Minimal: result = "minimal"; break;
            case ReasoningLevel.Low:     result = "low"; break;
            case ReasoningLevel.Medium:  result = "medium"; break;
            case ReasoningLevel.High:    result = "high"; break;
            case ReasoningLevel.Max:     result = "max"; break;
    ...
    public static string? OpenAiEffort(string? word)
    {
        ...
        switch (level)
        {
            ...
            case ReasoningLevel.Medium:  result = "medium"; break;
            case ReasoningLevel.High:    result = "high"; break;
            case ReasoningLevel.Max:     result = "high"; break;
    ...
    public static int AnthropicBudget(string? word, int maxTokens)
    {
        ...
        switch (level)
        {
            case ReasoningLevel.Minimal: target = 1024; break;
            case ReasoningLevel.Low:     target = 4096; break;
            case ReasoningLevel.Medium:  target = 8192; break;
            case ReasoningLevel.High:    target = 16384; break;
            case ReasoningLevel.Max:     target = 32000; break;
